...
return [
    ...
    */
    ...
    /* 追記 */
    'alphanumhalf'        => ':attributeは、半角英数字と_(アンダーバー)で入力して下さい。',
    ...
    | convention "attribute.rule" to name the lines. This makes it FLEX to
    ...
    */
    ...
    'custom' => [
        'terms' => [
            'required' => '利用規約・キャンセルポリシーの同意にチェックを入れてください。',
        ],
    ],
