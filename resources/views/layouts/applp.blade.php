...
<header id="header">
  <div class="header_in">
    ...
    <div class="header_top">
      <div class="h_logo">
        <a href="{{ route('lp_top') }}"><img src="{{ asset('/') }}images/h_logo.png" alt="買取シマエナガ"></a>
      </div>
  
      <div class="h_content02">
        <div class="h_links01 sp-none">
          <a href="{{ route('lp_top') }}" title="ホーム">ホーム</a>　
          <a href="{{ route('lp_service') }}" title="ご利用ルール">ご利用ルール</a>　
          <a href="{{ route('lp_company') }}" title="会社概要">会社概要</a>　
          <a href="{{ route('lp_privacy') }}" title="プライバシーポリシー">プライバシーポリシー</a>
        </div>
      ...
      <nav class="nav_content">
            <ul class="nav_list">
              <li class="nav_item">- <a href="{{ route('lp_top') }}" title="HOME">HOME</a>
              <li class="nav_item">- <a href="{{ route('lp_service') }}" title="ご利用ルール">ご利用ルール</a>
              <li class="nav_item">- <a href="{{ route('lp_company') }}" title="会社概要">会社概要</a>
              <li class="nav_item">- <a href="{{ route('lp_privacy') }}" title="プライバシーポリシー">プライバシーポリシー</a></li>
              <li class="nav_item">- <a href="{{config('app.com_linelp')}}" title="簡単LINE申込">簡単LINE申込</a></li>
            </ul>
      </nav>
      </div>
...
<div class="footer">
	<div class="footer_in">
      ...
      <div class="f_navi sp-none">
        <a href="{{ route('lp_top') }}" title="HOME">HOME</a>　|　
        <a href="{{ route('lp_service') }}" title="ご利用ルール">ご利用ルール</a>　|　
        <a href="{{ route('lp_company') }}" title="会社概要">会社概要</a>　|　
        <a href="{{ route('lp_privacy') }}" title="プライバシーポリシー">プライバシーポリシー</a>　|　
      </div>
...
<div class="modal-window" data-id="modal1">
  ...
  <div class="modal_in_box">
    <a href="{{config('app.com_linelp')}}" target="_blank"><img src="{{ asset('/') }}images/line_btn.png" alt="友達追加ボタン"></a>
  </div>
